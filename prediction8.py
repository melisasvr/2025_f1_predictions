...
# FIX APPLIED HERE: Changed 'sector_times_2023' to 'sector_times_2024'
...
qualifying_2025 = pd.DataFrame({
    ...
    "QualifyingTime (s)": [  
        ...
        69.954,  # NOR (1:09.954)
        70.129,  # PIA (1:10.129)
        None,    # RUS (DNF) - Note: This None will be imputed later
        71.362,  # SAI (1:11.362)
        71.213,  # ALB (1:11.213)
        70.063,  # LEC (1:10.063)
        70.942,  # OCO (1:10.942)
...
# --- FIXED WEATHER DATA ---
# API call has been removed. Hardcoding weather values for dry conditions.
rain_probability = 0.1  # Assuming dry track (10% rain prob)
temperature = 25.0      # Assuming moderate temperature (25 C)
# --------------------------

# adjust qualifying time based on weather conditions
# We use the raw qualifying time since we assume dry conditions.
...
# Note: Using 'TotalSectorTime (s)' from 2024 to train the model
merged_data = qualifying_2025.merge(sector_times_2024[["Driver", "TotalSectorTime (s)"]], on="Driver", how="left")
merged_data["RainProbability"] = rain_probability
merged_data["Temperature"] = temperature
# 'QualifyingTime' is already set above: merged_data["QualifyingTime"] = merged_data["QualifyingTime"]
...
plt.tight_layout()
# Note: plt.show() will be called when the script finishes execution in your terminal.
# The code below is already set up to save to files and print the podium.
# plt.savefig("clean_air_race_pace_vs_predicted_time.png") 
# plt.close() 
